...
(async () => {
  ...
  await fs.writeFile("thalassaemia-trait-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("thalassaemia-trait-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
